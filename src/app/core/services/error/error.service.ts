...
export enum ClientError {
  ...
  HTTP_428_PRECONDTION_REQUIRED = 422,
  HTTP_429_TOO_MANY_REQUEST = 423,
  HTTP_431_REQUEST_HEADER_FIELDS_TOO_LARGE = 424,
  HTTP_451_UNAVAILABE_FOR_LEGAL_REASONS = 425,
...
export class ErrorService {
  ...
  //       this._ui.openErrorSnackBar('Server Temporarily Down');
  //       break;

  //     case ClientError.HTTP_400_BAD_REQUEST:
  //       this.ui.openErrorSnackBar('Incorrect Credentials');
  //   }
  // }
